...
class GenericStack<T>{
	...
	GenericStack<Integer> s1 = new GenericStack<Integer>(new Integer[10]);
		...
		GenericStack<String> s2 = new GenericStack<String>(new String[10]);
		s2.push("Hello");
		s2.push("World");
		s2.push("I");
		s2.push("Am");
		...
		*/
		...
		GenericStack<Generic_Employee> gemp = new GenericStack<Generic_Employee>(new Generic_Employee[10]);
